...
public class HttpRequest {
    ...
    private static final int MAX_RETRIES = 9999;
     ...
     */
    public static int doOperationAndWaitForResult(String url, String param) {
        // Do some asynchronous operation.
        var token = sendPost(url, param);
        int retries = 0;
        boolean retry = false;
        var id = 1;
        do {
    ...
    private static Results getAsyncOperationResult(JSONObject token) {
        if (token.isEmpty()){return Results.FAILED;}
